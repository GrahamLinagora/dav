...
exports.createCalendar = function(calendarUrl, options) {
  var req = request.mkcalendar({
    props: [
      { name: 'displayname', namespace: ns.DAV, value: options.displayname },
      { name: 'calendar-description', 
				namespace: ns.CALDAV, value: options.description },
    ]
  });

  return options.xhr.send(req, calendarUrl, { sandbox: options.sandbox });
};
